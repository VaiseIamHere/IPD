...
def main():
    ...
    val_dir = "/kaggle/input/drdataset/dataset/Testing"  # <<< Add your validation folder here
    ...
    model_path = '/kaggle/input/medmambaimp/pytorch/default/1/mamba_inputscaledgelu_checkpoint89.pth'
    f = torch.load(model_path, weights_only=True)
    net.load_state_dict(f["model_state_dict"], strict=True)

    # Save model details
    model_name = "mamba_tuned"
